...
3.	Configurar el enrutamiento estático para que las tramas que salen de la red A hacia la red B sigan la ruta R2 - R0 - R3
4.	Configurar el enrutamiento estático para que las tramas que salen de la red B hacia la red A sigan la ruta R3 - R1 - R2
