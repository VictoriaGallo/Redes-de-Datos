...
1. Diseñar y simular la siguiente red de tal manera que todos los dispositivos de la Subred1 la Subred 2 y la Subred 3 tengan conexión entre si.
...
1. Realizar los cálculos de todas las subredes
2. Configuras las direcciones IP en todos los host de la red.
3. Realizar la configuración de enrutamiento Estático en la subred 4 y subred 5
4. Realizar la configuración de enrutamiento Dinámico  en la subred 6, subred 7 y subred 8.
